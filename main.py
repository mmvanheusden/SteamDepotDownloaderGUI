...
username = Entry(window, font=('Arial', 13))
username.grid(row=0, column=1)
password = Entry(window, show="*", font=('Arial', 13))
password.grid(row=1, column=1)
appid = Entry(window, font=('Arial', 13))
appid.grid(row=2, column=1)
depotid = Entry(window, font=('Arial', 13))
depotid.grid(row=3, column=1)
manifestid = Entry(window, font=('Arial', 13))
